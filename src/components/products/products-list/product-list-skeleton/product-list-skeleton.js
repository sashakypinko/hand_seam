...
const ProductItemSimpleTileSkeleton = () => {
    return (
        <div className={`col-md-3 mb-5`}>
            <div>
                <div className="view zoom overlay rounded z-depth-2">
                    <Skeleton variant="rect" height={285} width="100%"/>
                </div>
                <div className="pt-4">
                    <div className="d-flex justify-content-center">
...
export const ProductListsSimpleTilesSkeleton = () => {
    return (
        <>
            <ProductItemSimpleTileSkeleton/>
            <ProductItemSimpleTileSkeleton/>
            <ProductItemSimpleTileSkeleton/>
            <ProductItemSimpleTileSkeleton/>
        </>
